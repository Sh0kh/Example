                ...
                {Data.map((exam) => (
                    <Card key={exam.id} className="shadow-md">
                        ...
                        <CardBody>
                            ...
                            <Typography color="gray" className="text-sm">
                                Narx: <span className="font-medium">{Number(exam.price).toLocaleString("ru-RU")}</span>
                            </Typography>
                            <Typography color="gray" className="text-sm">
                                Status: <span className="font-medium">{exam?.status === "active" ? "Faol" : "Nofaol"}</span>
                            </Typography>
                            <CenterExamStatusEditModal Examstatus={exam?.status} refresh={getAllExams} type={exam?.type_id} examId={exam?.id} />
                        </CardBody>
                    </Card>
                ))}
            </div>
